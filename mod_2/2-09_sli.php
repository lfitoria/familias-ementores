					...
					<div class="cont row justify-content-center">
						<div class="col-12">
							...
							<div class="tab-content" id="myTabContent">
									...
									<div class="slider1">
										<div class="slide">
											<div class="row justify-content-start">
												...
												<div class="col-12 col-md-6">
													<img src="../img/mod2/2-09_sli-diapositiva-2.png" alt="Slide1">
												</div>
										...
										<div class="slide">
											<div class="row justify-content-start">
												<div class="col-12 col-md-6">
													<img src="../img/mod2/2-09_sli-diapositiva-3.png" alt="Slide2">
												</div>
												<div class="col-12 col-md-6">
								...
								<div class="tab-pane fade" id="sexting" role="tabpanel" aria-labelledby="sexting-tab">
									<div class="slider2">
										<div class="slide">
											<div class="row justify-content-start">
												<div class="col-12 col-md-6">
													<p class="title">Prevención de los peligros del sexting 01</p>
												...
												<div class="col-12 col-md-6">
													<img src="../img/mod2/2-09_sli-diapositiva-4.png" alt="Slide1">
												</div>
										...
										<div class="slide">
											<div class="row justify-content-start">
												...
												<div class="col-12 col-md-6">
													<img src="../img/mod2/2-09_sli-diapositiva-5.png" alt="Slide1">
												</div>
								...
								<div class="tab-pane fade" id="grooming" role="tabpanel" aria-labelledby="grooming-tab">
									<div class="slider3">
										<div class="slide">
											<div class="row justify-content-start">
												<div class="col-12">
													<p class="title">Prevención de los peligros del grooming 01</p>
										...
										<div class="slide">
											<div class="row justify-content-start">
												<p class="title col-12">Prevención de los peligros del grooming 02</p>
												<div class="col-12 col-md-6">
								...
								<div class="tab-pane fade" id="ciberbullying" role="tabpanel" aria-labelledby="ciberbullying-tab">
									<div class="slider4">
										<div class="slide">
											<div class="row justify-content-start">
												<div class="col-12">
													<p class="title">Prevención de los peligros del ciberbullying 01</p>
												...
												<div class="col-12">
													<img src="../img/mod2/2-09_sli-diapositiva-9.png" alt="Slide1">
												</div>
										...
										<div class="slide">
											<div class="row justify-content-start">
												<p class="title col-12">Prevención de los peligros del ciberbullying 02</p>
												<div class="col-12">
										...
										<div class="slide">
											<div class="row justify-content-start">
												<p class="col-12" class="title">Prevención de los peligros del ciberbullying 03</p>
												<div class="col-12 col-md-6">
