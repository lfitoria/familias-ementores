        ...
        <div class="wrapper">
            ...
            <div id="content"> 
                ...
                <section class="container">
					...
					<br>
					Elija si lo más adecuado es aceptarlas o rechazarlas.</p>
					</div>
                    <div class="main ">
                        <div class="row box-solicitud">
                        	<div class="col-2">
                    			<img src="../img/mod2/2-05_act_img-noimagen.jpeg" alt="" class="img-fluid"/>
                        	</div>
                        	<div class="col-7 row bck-grey">
                        		<h3>Jason</h3>
                        		<p>No tiene foto de perfil, publica pocas cosas y casi no tiene contactos. Comparte chistes con contenidos sexuales.
								</p>
                        	</div>
                        	<div class="col-3 row bck-grey">
                        		<button data-modl="1">Aceptar</button>
                        		<button data-modl="2">Eliminar solicitud</button>
                        	</div>
                        </div>
                        <div class="row box-solicitud">
                        	<div class="col-2">
                        	...
                        	<div class="col-3 row bck-grey">
                        		<button data-modl="3">Aceptar</button>
                        		<button data-modl="4">Eliminar solicitud</button>
                        	</div>
                        </div>
                        <div class="row box-solicitud">
                        	<div class="col-2">
                        	...
                        	<div class="col-7 row bck-grey">
                        		<h3>Byron</h3>
                        		<p>En su perfil no hay foto.  Dice que tiene 16 años y que le gusta hacer amigos y jugar videojuegos.  Karla no sabe quién es.
								</p>
                        	</div>
                        	<div class="col-3 row bck-grey">
                        		<button data-modl="5">Aceptar</button>
                        		<button data-modl="6">Eliminar solicitud</button>
                        	</div>
                        </div>
                        <div class="row box-solicitud">
                        	<div class="col-2">
                        	...
                        	<div class="col-7 row bck-grey">
                        		<h3>Javier</h3>
                        		<p>Es un muchacho del barrio.  Es conocido de la familia de Karla y ha visitado la casa en ocasiones.  Estudian en el  mismo colegio.
								</p>
                        	</div>
                        	<div class="col-3 row bck-grey">
                        		<button data-modl="7">Aceptar</button>
                        		<button data-modl="8">Eliminar solicitud</button>
                        	</div>
                        </div>
                        <div class="row box-solicitud">
                        	<div class="col-2">
                        	...
                        	<div class="col-7 row bck-grey">
                        		<h3>José Alberto</h3>
                        		<p>Es una persona de 30 años. En su perfil se ven fotos en fiestas con mujeres mucho más jóvenes que él.
								</p>
                        	</div>
                        	<div class="col-3 row bck-grey">
                        		<button data-modl="9">Aceptar</button>
                        		<button data-modl="10">Eliminar solicitud</button>
                        	</div>
                        </div>
                    </div>
                </section>
