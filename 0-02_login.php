<html class="page-02-login">
    <head>
        <meta htFequiv="Expires" content="0" />
                                ...
                                <div class="col-sm-10 main-block">
                                    ...
                                    if ($incorrect_user) {
                                        ...
                                        <div class="alert alert-warning" role="alert">
                                            ¡Huummm! Al parecer esta cuenta no ha sido registrada aún. Corrobórelo y vuelva a intentarlo.
                                        </div>
                                    <?php } ?>
                                    ...
                                    if ($duplicated_user) {
                                        ?>
                                        <div class="alert alert-warning" role="alert">
                                            Oh oh, parece que esta cuenta ya está registrado
                                        </div>
                                    <?php } ?>
                                    <div class="radio">
                                        <label>
                                    ...
                                    <form action="db/user/insert_user.php" method="POST" >
                                        ...
                                        <div class="form-group id-input resi-id d-none">
                                            ...
                                            <input type="text" name="id_r" class="form-control text-number mr-auto" id="cr-id-input2" aria-describedby="idHelp" minlength="12" maxlength="12" placeholder="1NNN-CC...C-EE...E">
